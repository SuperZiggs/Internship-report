...
| --- | --------- | ------------ | --------------- | -------------- |
| 2   | - Triển khai **com.example.fitme.common.exception.GlobalExceptionHandler** (`@RestControllerAdvice`) <br>&emsp; + Xử lý `MethodArgumentNotValidException` → lỗi validation theo field <br>&emsp; + Xử lý `EntityNotFoundException`, các business exception tùy chỉnh <br>&emsp; + Tất cả lỗi trả về qua `ApiResponse` envelope | 20/01/2026 | 20/01/2026 | |
